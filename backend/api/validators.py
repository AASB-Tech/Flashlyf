...
from api.constants import memory_size
...
def validate_image_file_size(file, min_size=0, max_size=10*memory_size.MB):
...
def validate_audio_file_size(file, min_size=0, max_size=50*memory_size.MB):
    """ Thin wrapper around validate_file_size with default min/max values for audio."""
    return validate_file_size(file, min_size=min_size, max_size=max_size)

def validate_video_file_size(file, min_size=0, max_size=100*memory_size.MB):
