...
class FlashLyfJSONRenderer(JSONRenderer):
    """ Renderer that defines the standard json response within FlashLyf """

    @staticmethod
    def flashlyf_json(data):
        return {
    ...
    def render(self, data_obj, accepted_media_type=None, renderer_context=None):
        ...
        if isinstance(data_obj, dict):
            data_obj = self.flashlyf_json(data_obj)
